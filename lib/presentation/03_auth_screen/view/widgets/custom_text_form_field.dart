...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget? _getPrefixIcon(ThemeMode themeMode) {
    ColorFilter colorFilter = themeMode == ThemeMode.dark
        ? ColorFilter.mode(ColorsManager.offwhite, BlendMode.srcIn)
        : ColorFilter.mode(ColorsManager.grey, BlendMode.srcIn);
    switch (widget.inputType) {
      case TextInputType.name:
        return SvgPicture.asset(SvgAssets.name,
            fit: BoxFit.scaleDown, colorFilter: colorFilter);
      case TextInputType.visiblePassword:
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon:
            widget.prefixIcon ?? _getPrefixIcon(themeProvider.themeMode),
        suffixIcon:
            widget.suffixIcon ?? _getSuffixIcon(themeProvider.themeMode),
      ),
    );
  }
}
